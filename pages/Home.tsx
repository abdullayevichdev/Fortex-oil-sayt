        ...
        <div className="container mx-auto px-4 relative z-20 pt-16">
          <div className="max-w-3xl space-y-8">
            <div className="inline-block px-4 py-1 border border-blue-500/50 rounded-full bg-blue-500/10 backdrop-blur-sm text-blue-400 text-sm font-bold uppercase tracking-wider animate-fade-in-up">
              №1 Avtomobil Moylar Markazi
            </div>
            <h1 className="text-5xl md:text-7xl font-black leading-tight animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              Dvigatelingiz Uchun <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Mukammal Himoya</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              Bizning premium toifadagi motor moylarimiz dvigatelingizning ishlash muddatini uzaytiradi va maksimal quvvatni ta'minlaydi.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              <Link to="/products" className="group bg-fortex-primary hover:bg-blue-600 text-white font-bold py-4 px-10 rounded-lg transition-all shadow-lg shadow-blue-500/30 flex items-center justify-center">
                Katalogga O'tish <ArrowRight className="ml-2 group-hover:translate-x-1 transition" />
              </Link>
      ...
      <div className="container mx-auto px-4 -mt-20 relative z-30 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-2 transition duration-500">
                ...
                <h3 className="text-xl font-bold mb-3 text-slate-800">100% Asl Mahsulot</h3>
                <p className="text-gray-500 leading-relaxed">Biz faqat sertifikatlangan va tekshirilgan brendlarning asl mahsulotlarini taklif etamiz.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-2 transition duration-500">
                <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-6 text-fortex-primary">
                    <Zap size={32} />
                </div>
                <h3 className="text-xl font-bold mb-3 text-slate-800">Tezkor Yetkazib Berish</h3>
                <p className="text-gray-500 leading-relaxed">Buyurtmangizni qisqa vaqt ichida manzilingizga xavfsiz yetkazib beramiz.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-2 transition duration-500">
                <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-6 text-fortex-primary">
                    <Award size={32} />
                </div>
                <h3 className="text-xl font-bold mb-3 text-slate-800">Professional Maslahat</h3>
                <p className="text-gray-500 leading-relaxed">Mutaxassislarimiz avtomobilingiz uchun eng mos moyni tanlashda yordam berishadi.</p>
            </div>
        </div>
      </div>
