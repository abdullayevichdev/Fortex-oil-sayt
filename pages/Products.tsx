       ...
       <div className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 bg-fortex-dark text-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 text-center">
             <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-400/30 backdrop-blur-sm text-blue-300 text-xs font-bold uppercase tracking-widest mb-6 animate-fade-in-up">
                <Layers size={14} />
                <span>Premium Katalog</span>
             </div>
             <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                Barcha <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Mahsulotlar</span>
             </h1>
             <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                Avtomobilingiz uchun eng mos keluvchi yuqori sifatli moylash vositalarini saralab oldik. Sifat va ishonch kafolatlangan.
             </p>
          </div>
       </div>
       ...
       <div className="container mx-auto px-4 -mt-16 relative z-30">
        ...
        {filteredProducts.length === 0 && (
           <div className="text-center py-20 animate-fade-in">
             ...
             <h3 className="text-2xl font-black text-slate-800 mb-2">Hech narsa topilmadi</h3>
             <p className="text-gray-500">Qidiruv so'zini o'zgartirib ko'ring yoki boshqa toifani tanlang.</p>
           </div>
        )}
      </div>
        ...
        {selectedProduct && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-2xl flex items-center justify-center border border-gray-100 relative overflow-hidden group">
              ...
              <img src={selectedProduct.image_url} alt={selectedProduct.name} className="max-h-80 object-contain drop-shadow-lg z-10 transition duration-500 group-hover:scale-110" />
            </div>
            <div>
              ...
              <div className="bg-white p-5 rounded-xl mb-6 border border-gray-100 shadow-sm">
                <p className="text-sm text-gray-500 mb-3 font-medium">Mavjud hajmlar:</p>
              ...
              <div className="mb-8">
                <h3 className="font-bold text-slate-800 mb-2">Tavsif:</h3>
